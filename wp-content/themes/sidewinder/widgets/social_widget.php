...
class SocialWidget extends WP_Widget {
    function SocialWidget() {
        parent::WP_Widget(false, $name = 'Sidewinder Social');	
    }
...
<?php if ( $delicious ) echo "<a href=\"$instance[delicious]\" title=\"Delicious Profile\"><img src=\"$WP_THEME_URL/assets/img/social/delicious_16.png\" alt=\"Delicious\" /></a> "; ?>
<?php if ( $deviantart ) echo "<a href=\"$instance[deviantart]\" title=\"deviantArt Profile\"><img src=\"$WP_THEME_URL/assets/img/social/deviantart_16.png\" alt=\"DeviantArt\"/></a> "; ?>
<?php if ( $email ) echo "<a href=\"$instance[email]\" title=\"Email Address\"><img src=\"$WP_THEME_URL/assets/img/social/email_16.png\" alt=\"Email\"/></a> "; ?>
<?php if ( $facebook ) echo "<a href=\"$instance[facebook]\" title=\"Facebook Profile\"><img src=\"$WP_THEME_URL/assets/img/social/facebook_16.png\" alt=\"Facebook\"/></a> "; ?>
<?php if ( $flickr ) echo "<a href=\"$instance[flickr]\" title=\"Flickr Profile\"><img src=\"$WP_THEME_URL/assets/img/social/flickr_16.png\" alt=\"Flickr\"/></a> "; ?>
<?php if ( $linkedin ) echo "<a href=\"$instance[linkedin]\" title=\"LinkedIn Profile\"><img src=\"$WP_THEME_URL/assets/img/social/linkedin_16.png\" alt=\"LinkedIn\"/></a> "; ?>
<?php if ( $myspace ) echo "<a href=\"$instance[myspace]\" title=\"MySpace Profile\"><img src=\"$WP_THEME_URL/assets/img/social/myspace_16.png\" alt=\"MySpace\"/></a> "; ?>
<?php if ( $netvibes ) echo "<a href=\"$instance[netvibes]\" title=\"NetVibes Profile\"><img src=\"$WP_THEME_URL/assets/img/social/netvibes_16.png\" alt=\"NetVibes\"/></a> "; ?>
<?php if ( $reddit ) echo "<a href=\"$instance[reddit]\" title=\"Reddit Profile\"><img src=\"$WP_THEME_URL/assets/img/social/reddit_16.png\" alt=\"Reddit\"/></a> "; ?>
<?php if ( $rss ) echo "<a href=\"$instance[rss]\" title=\"RSS Profile\"><img src=\"$WP_THEME_URL/assets/img/social/rss_16.png\" alt=\"RSS\"/></a> "; ?>
<?php if ( $skype ) echo "<a href=\"$instance[skype]\" title=\"Skype Profile\"><img src=\"$WP_THEME_URL/assets/img/social/skype_16.png\" alt=\"Skype\"/></a> "; ?>
<?php if ( $tumblr ) echo "<a href=\"$instance[tumblr]\" title=\"Tumblr Profile\"><img src=\"$WP_THEME_URL/assets/img/social/tumblr_16.png\" alt=\"Tumblr\"/></a> "; ?>
<?php if ( $twitter ) echo "<a href=\"$instance[twitter]\" title=\"Twitter Profile\"><img src=\"$WP_THEME_URL/assets/img/social/twitter_16.png\" alt=\"Twitter\"/></a> "; ?>
<?php if ( $stumbleupon ) echo "<a href=\"$instance[stumbleupon]\" title=\"StumbleUpon Profile\"><img src=\"$WP_THEME_URL/assets/img/social/stumbleupon_16.png\" alt=\"StumbleUpon\"/></a> "; ?>
<?php if ( $vimeo ) echo "<a href=\"$instance[vimeo]\" title=\"Vimeo Profile\"><img src=\"$WP_THEME_URL/assets/img/social/vimeo_16.png\" alt=\"Vimeo\"/></a> "; ?>
<?php if ( $youtube ) echo "<a href=\"$instance[youtube]\" title=\"YouTube Profile\"><img src=\"$WP_THEME_URL/assets/img/social/youtube_16.png\" alt=\"YouTube\"/></a> "; ?>
